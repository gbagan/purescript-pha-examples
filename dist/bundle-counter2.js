...
(function($PS) {
  ...
  var monadAffUpdate = new Effect_Aff_Class.MonadAff(function () {
      ...
      return Update(Control_Monad_Free.liftF(Lift.create($8)));
  });
  var functorUpdateF = new Data_Functor.Functor(function (f) {
      return function (v) {
          if (v instanceof State) {
              return new State((function () {
                  var $9 = Data_Bifunctor.lmap(Data_Bifunctor.bifunctorTuple)(f);
                  return function ($10) {
...
(function($PS) {
  ...
  var Pha_Html_Core = $PS["Pha.Html.Core"];
  var span = Pha_Html_Core.h("span");
  var hr = function (attrs) {
      return Pha_Html_Core.h("hr")(attrs)([  ]);
  };                             
  var h3 = Pha_Html_Core.h("h3");        
...
(function($PS) {
  // Generated by purs version 0.14.1
  "use strict";
  $PS["Pha.Subscriptions"] = $PS["Pha.Subscriptions"] || {};
  var exports = $PS["Pha.Subscriptions"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Data_Functor = $PS["Data.Functor"];
  var Data_Maybe = $PS["Data.Maybe"];
  ...
  var makeSubscription = function (sub) {
      return function (d) {
          return function (dispatch) {
              return sub(dispatch)(d);
          };
      };
  };
  var on = function (n) {
              ...
              return function (decoder) {
                  return function (ev) {
                      return function __do() {
                          ...
                          throw new Error("Failed pattern match at Pha.Subscriptions (line 27, column 24 - line 29, column 36): " + [ v.constructor.name ]);
                      };
                  };
              };
          };
          var fn = function (dispatch) {
              return function (v) {
                  return function __do() {
                      ...
                      return Control_Bind.bind(Effect.bindEffect)(Data_Functor.mapFlipped(Effect.functorEffect)(Web_HTML.window)(Web_HTML_Window.toEventTarget))(Web_Event_EventTarget.addEventListener(v.name)(listener)(false))();
                  };
              };
          };
...
(function($PS) {
  ...
  var Pha_Subscriptions = $PS["Pha.Subscriptions"];
  var Pha_Update = $PS["Pha.Update"];                
  ...
  var update = function (v) {
      ...
      throw new Error("Failed pattern match at Example.Counter2 (line 25, column 1 - line 25, column 33): " + [ v.constructor.name ]);
  };
  var state = 0;
  ...
  var view = function (counter) {
      return Pha_Html_Elements.div([  ])([ Pha_Html_Elements.div([ Pha_Html_Core.class_("counter") ])([ Pha_Html_Core.text(Data_Show.show(Data_Show.showInt)(counter)) ]), Pha_Html_Elements.button([ Pha_Html_Events.onClick(Increment.value) ])([ Pha_Html_Core.text("Increment") ]), Pha_Html_Elements.button([ Pha_Html_Events.onClick(DelayedIncrement.value) ])([ Pha_Html_Core.text("Delayed Increment") ]), Pha_Html_Elements.div([  ])([ Pha_Html_Elements.span([  ])([ Pha_Html_Core.text("green when the counter is even") ]), Pha_Html_Elements.div([ Pha_Html_Core.class_("box"), Pha_Html_Core["class'"]("even")(Data_Int.even(counter)) ])([  ]) ]), Pha_Html_Elements.h3([  ])([ Pha_Html_Core.text("press I to increment the counter") ]), Pha_Html_Elements.hr([  ]), Pha_Html_Elements.h3([  ])([ Pha_Html_Core.text("keyed") ]), Pha_Html_Core.keyed("div")([  ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Functor.mapFlipped(Data_Functor.functorArray)(Data_Array.range(0)(Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(counter)(4)))(function (i) {
          ...
          return new Data_Tuple.Tuple(Data_Show.show(Data_Show.showInt)(i), Pha_Html_Core.text(Data_Show.show(Data_Show.showInt)(i)));
      })))), Pha_Html_Elements.hr([  ]), Pha_Html_Elements.h3([  ])([ Pha_Html_Core.text("non keyed") ]), Pha_Html_Elements.div([  ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Functor.mapFlipped(Data_Functor.functorArray)(Data_Array.range(0)(Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(counter)(4)))(function (i) {
          return Pha_Html_Core.text(Data_Show.show(Data_Show.showInt)(i));
      }))(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Html_Core.text("test") ])(Data_Functor.mapFlipped(Data_Functor.functorArray)(Data_Array.range(0)(Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(counter)(4)))(function (i) {
          return Pha_Html_Core.text(Data_Show.show(Data_Show.showInt)(i));
      })))), Pha_Html_Elements.hr([  ]), Pha_Html_Elements.h3([  ])([ Pha_Html_Core.text("lazy") ]), Pha_Html_Core.lazy(spanCounter)(Data_EuclideanRing.div(Data_EuclideanRing.euclideanRingInt)(counter)(2)), Pha_Html_Elements.hr([  ]), Pha_Html_Elements.h3([  ])([ Pha_Html_Core.text("duplicate") ]), Pha_Html_Elements.div([  ])(Data_Array.replicate(Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(counter)(4))(Pha_Html_Core.text("t"))) ]);
  };
  ...
  var main = Pha_App.app({
      ...
      view: view,
      update: update,
      subscriptions: [ Pha_Subscriptions.onKeyDown(keyDownHandler) ],
      selector: "#root"
  });
  exports["state"] = state;
