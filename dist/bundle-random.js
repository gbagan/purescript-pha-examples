...
(function($PS) {
  ...
  var get = Update(Control_Monad_Free.liftF(new Get(Control_Category.identity(Control_Category.categoryFn))));
  ...
  var functorUpdate = Control_Monad_Free.freeFunctor;
  ...
  exports["functorUpdate"] = functorUpdate;
...
(function($PS) {
  ...
  var interpret = function (v) {
      return function (v1) {
          var go = function (v2) {
              ...
              throw new Error("Failed pattern match at Pha.App (line 102, column 5 - line 102, column 38): " + [ v2.constructor.name ]);
          };
  ...
  var app$prime = function (v) {
                      ...
                      return function (vdom) {
                          ...
                          var render = function (newVDom) {
                              return function __do() {
                                  ...
                                  throw new Error("Failed pattern match at Pha.App (line 54, column 17 - line 60, column 45): " + [ pnode.constructor.name ]);
                              };
                          };
                          ...
                          var listener = function (e) {
                              ...
                              throw new Error("Failed pattern match at Pha.App (line 94, column 13 - line 98, column 39): " + [ v2.constructor.name ]);
                          };
                          var dispatchEvent = function (ev) {
                              return function (handler) {
                                  return function __do() {
                                      ...
                                      throw new Error("Failed pattern match at Pha.App (line 88, column 25 - line 90, column 48): " + [ msg.constructor.name ]);
                                  };
                              };
                          };
                          ...
                          return function __do() {
                              ...
                              throw new Error("Failed pattern match at Pha.App (line 44, column 9 - line 46, column 32): " + [ v.init.action.constructor.name ]);
                          };
                      };
                  };
              };
      ...
      return function __do() {
          ...
          throw new Error("Failed pattern match at Pha.App (line 32, column 5 - line 40, column 41): " + [ selected.constructor.name ]);
      };
  };
  var app = function (v) {
      return app$prime({
...
(function($PS) {
  ...
  var update = function (v) {
      ...
      if (v instanceof ShufflePuzzle) {
          return Control_Bind.bind(Pha_Update.bindUpdate)(Data_Functor.mapFlipped(Pha_Update.functorUpdate)(Pha_Update.get)(function (v1) {
              return v1.puzzle;
          }))(function (p) {
      ...
      throw new Error("Failed pattern match at Example.Random (line 52, column 1 - line 52, column 28): " + [ v.constructor.name ]);
  };
