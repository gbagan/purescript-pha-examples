...
})(PS["Pha.Html.Core"] = PS["Pha.Html.Core"] || {});
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  $PS["Pha.Html.Core"] = $PS["Pha.Html.Core"] || {};
  var exports = $PS["Pha.Html.Core"];
  var $foreign = $PS["Pha.Html.Core"];
...
(function($PS) {
  ...
  var monadStateUpdate = new Control_Monad_State_Class.MonadState(function () {
      return monadUpdate;
  }, function ($5) {
      return Update(Control_Monad_Free.liftF(State.create($5)));
  });                                                  
  var monadEffectUpdate = new Effect_Class.MonadEffect(function () {
      ...
      return function ($7) {
          return Update(Control_Monad_Free.liftF(Lift.create($6($7))));
      };
  })());
      ...
      return function (v) {
          if (v instanceof State) {
              return new State((function () {
                  var $9 = Data_Bifunctor.lmap(Data_Tuple.bifunctorTuple)(f);
                  return function ($10) {
                      return $9(v.value0($10));
                  };
              })());
          };
          if (v instanceof Lift) {
              return new Lift(Data_Functor.map(Effect_Aff.functorAff)(f)(v.value0));
          };
          throw new Error("Failed pattern match at Pha.Update (line 16, column 1 - line 18, column 36): " + [ f.constructor.name, v.constructor.name ]);
      };
  });
  ...
  exports["monadStateUpdate"] = monadStateUpdate;
  exports["monadEffectUpdate"] = monadEffectUpdate;
})(PS);
(function(exports) {
  "use strict";
...
(function($PS) {
  ...
  var Pha_Html_Core = $PS["Pha.Html.Core"];
  ...
  var interpret = function (v) {
      return function (v1) {
          var go = function (v2) {
              if (v2 instanceof Pha_Update.State) {
                  return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(v.get))(function (st) {
                      var v3 = v2.value0(st);
                      return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(v.put(v3.value1)))(function () {
              ...
              throw new Error("Failed pattern match at Pha.App (line 105, column 5 - line 109, column 15): " + [ v2.constructor.name ]);
          };
  ...
  var app$prime = function (v) {
              ...
              return function (node) {
                  return function (vdom) {
                      ...
                      var setState = function (newState) {
                          return function __do() {
                              var oldState = Effect_Ref.read(state)();
                              return Control_Applicative.unless(Effect.applicativeEffect)(Unsafe_Reference.unsafeRefEq(oldState)(newState))(function __do() {
                      ...
                      var render = function (newVDom) {
                          return function __do() {
                              ...
                              throw new Error("Failed pattern match at Pha.App (line 58, column 17 - line 64, column 45): " + [ pnode.constructor.name ]);
                          };
                      };
                      var listener = function (e) {
                          ...
                          throw new Error("Failed pattern match at Pha.App (line 97, column 13 - line 101, column 39): " + [ v2.constructor.name ]);
                      };
                      var dispatchEvent = function (ev) {
                          return function (handler) {
                              return function __do() {
                                  ...
                                  throw new Error("Failed pattern match at Pha.App (line 91, column 25 - line 93, column 48): " + [ msg.constructor.name ]);
                              };
                          };
                      };
                      ...
                      return function __do() {
                          ...
                          throw new Error("Failed pattern match at Pha.App (line 48, column 9 - line 50, column 32): " + [ v.init.action.constructor.name ]);
                      };
                  };
              };
          };
      ...
      return function __do() {
          ...
          if (selected instanceof Data_Maybe.Just) {
              ...
              var vdom = Effect_Ref["new"](Pha_Html_Core.text(""))();
              return go(state)(lock)(node)(vdom)();
          };
          throw new Error("Failed pattern match at Pha.App (line 35, column 5 - line 43, column 36): " + [ selected.constructor.name ]);
      };
  };
  var app = function (v) {
      return app$prime({
...
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  $PS["Pha.Html.Elements"] = $PS["Pha.Html.Elements"] || {};
  var exports = $PS["Pha.Html.Elements"];
  var Pha_Html_Core = $PS["Pha.Html.Core"];
  var div = Pha_Html_Core.h("div");
  var button = Pha_Html_Core.h("button");
...
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  $PS["Pha.Html.Events"] = $PS["Pha.Html.Events"] || {};
  var exports = $PS["Pha.Html.Events"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Data_Maybe = $PS["Data.Maybe"];
  var Effect = $PS["Effect"];
  var Pha_Html_Core = $PS["Pha.Html.Core"];
  var on = Pha_Html_Core.unsafeOnWithEffect;
...
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  $PS["Pha.Html.Util"] = $PS["Pha.Html.Util"] || {};
  var exports = $PS["Pha.Html.Util"];
...
(function($PS) {
  ...
  var Pha_Html_Core = $PS["Pha.Html.Core"];
  var Pha_Html_Elements = $PS["Pha.Html.Elements"];
  var Pha_Html_Events = $PS["Pha.Html.Events"];
  var Pha_Html_Util = $PS["Pha.Html.Util"];
  var Pha_Update = $PS["Pha.Update"];                
  ...
  var viewCard = function (v) {
      ...
      throw new Error("Failed pattern match at Example.Random (line 64, column 1 - line 64, column 25): " + [ v.constructor.name ]);
  };
  var view = function (v) {
      return Pha_Html_Elements.div([  ])([ Pha_Html_Elements.div([ Pha_Html_Core["class'"]("counter")(true) ])([ Pha_Html_Core.text(Data_Show.show(Data_Show.showInt)(v.dice)) ]), Pha_Html_Elements.button([ Pha_Html_Events.onClick(RollDice.value) ])([ Pha_Html_Core.text("Roll dice") ]), Pha_Html_Elements.div([ Pha_Html_Core.style("font-size")("12em") ])([ Pha_Html_Core.text(viewCard(v.card)) ]), Pha_Html_Elements.button([ Pha_Html_Events.onClick(DrawCard.value) ])([ Pha_Html_Core.text("Draw") ]), Pha_Html_Core.keyed("div")([ Pha_Html_Core.class_("puzzle") ])(Data_Array.mapWithIndex(function (i) {
          return function (j) {
              return new Data_Tuple.Tuple(Data_Show.show(Data_Show.showInt)(i), Pha_Html_Elements.div([ Pha_Html_Core["class'"]("puzzle-item")(true), Pha_Html_Core.style("left")(Pha_Html_Util.pc(0.25 * Data_Int.toNumber(Data_EuclideanRing.div(Data_EuclideanRing.euclideanRingInt)(j)(4)))), Pha_Html_Core.style("top")(Pha_Html_Util.pc(0.25 * Data_Int.toNumber(Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(j)(4)))) ])([ Pha_Html_Core.text(Data_Show.show(Data_Show.showInt)(i)) ]));
          };
      })(v.puzzle)), Pha_Html_Elements.button([ Pha_Html_Events.onClick(ShufflePuzzle.value) ])([ Pha_Html_Core.text("Shuffle") ]) ]);
  };
  var state = {
      dice: 1,
  ...
  var randomPick = function (array) {
      return function __do() {
          var n = Effect_Random.randomInt(0)(Data_Array_NonEmpty.length(array) - 1 | 0)();
          return Data_Maybe.fromMaybe(Data_Array_NonEmpty.head(array))(Data_Array_NonEmpty.index(array)(n));
      };
  };
  ...
  var update = function (v) {
      if (v instanceof RollDice) {
          return Control_Bind.bind(Pha_Update.bindUpdate)(Effect_Class.liftEffect(Pha_Update.monadEffectUpdate)(Effect_Random.randomInt(1)(6)))(function (n) {
              return Control_Monad_State_Class.modify_(Pha_Update.monadStateUpdate)(function (v1) {
                  var $18 = {};
                  for (var $19 in v1) {
      ...
      if (v instanceof DrawCard) {
          return Control_Bind.bind(Pha_Update.bindUpdate)(Effect_Class.liftEffect(Pha_Update.monadEffectUpdate)(randomPick(cards)))(function (card) {
              return Control_Monad_State_Class.modify_(Pha_Update.monadStateUpdate)(function (v1) {
                  var $21 = {};
                  for (var $22 in v1) {
      ...
      if (v instanceof ShufflePuzzle) {
          return Control_Bind.bind(Pha_Update.bindUpdate)(Control_Monad_State_Class.gets(Pha_Update.monadStateUpdate)(function (v1) {
              return v1.puzzle;
          }))(function (p) {
              return Control_Bind.bind(Pha_Update.bindUpdate)(Effect_Class.liftEffect(Pha_Update.monadEffectUpdate)(shuffle(p)))(function (p2) {
                  return Control_Monad_State_Class.modify_(Pha_Update.monadStateUpdate)(function (v1) {
                      var $24 = {};
                      for (var $25 in v1) {
      ...
      throw new Error("Failed pattern match at Example.Random (line 52, column 1 - line 52, column 33): " + [ v.constructor.name ]);
  };
