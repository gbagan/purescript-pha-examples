...
(function($PS) {
  ...
  exports["monadAffUpdate"] = monadAffUpdate;
})(PS);
(function(exports) {
  "use strict";
...
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  $PS["Pha.Html.Attributes"] = $PS["Pha.Html.Attributes"] || {};
  var exports = $PS["Pha.Html.Attributes"];
  var Pha_Html_Core = $PS["Pha.Html.Core"]; 
  var src = Pha_Html_Core.attr("src");
  exports["src"] = src;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.8
  ...
  var Pha_Html_Core = $PS["Pha.Html.Core"];
  var img = Pha_Html_Core.h("img");
  var h2 = Pha_Html_Core.h("h2");        
...
(function($PS) {
  ...
  var Pha_Html_Attributes = $PS["Pha.Html.Attributes"];
  var Pha_Html_Core = $PS["Pha.Html.Core"];
  ...
  var viewGif = function (v) {
      if (v instanceof Failure) {
          return Pha_Html_Elements.div([  ])([ Pha_Html_Core.text("I could not load a random cat for some reason. "), Pha_Html_Elements.button([ Pha_Html_Events.onclick(RequestCat.value) ])([ Pha_Html_Core.text("Try Again!") ]) ]);
      };
      if (v instanceof Loading) {
          return Pha_Html_Core.text("Loading...");
      };
      if (v instanceof Success) {
          return Pha_Html_Elements.div([  ])([ Pha_Html_Elements.button([ Pha_Html_Events.onclick(RequestCat.value), Pha_Html_Core.style("display")("block") ])([ Pha_Html_Core.text("More Please!") ]), Pha_Html_Elements.img([ Pha_Html_Attributes.src(v.value0) ])([  ]) ]);
      };
      throw new Error("Failed pattern match at Example.Cats (line 44, column 1 - line 44, column 27): " + [ v.constructor.name ]);
  };
  var view = function (st) {
      return Pha_Html_Elements.div([  ])([ Pha_Html_Elements.h2([  ])([ Pha_Html_Core.text("Random Cats") ]), viewGif(st) ]);
  };
  var update = function (v) {
      return Control_Bind.discard(Control_Bind.discardUnit)(Pha_Update.bindUpdate)(Pha_Update.modify(Data_Function["const"](Loading.value)))(function () {
          return Control_Bind.bind(Pha_Update.bindUpdate)(Effect_Aff_Class.liftAff(Pha_Update.monadAffUpdate)(Affjax.get(Affjax_ResponseFormat.json)("https://api.giphy.com/v1/gifs/random?api_key=dc6zaTOxFJmzC&tag=cat")))(function (res) {
              var status = (function () {
                  if (res instanceof Data_Either.Left) {
                      return Failure.value;
                  };
                  if (res instanceof Data_Either.Right) {
                      var v1 = Control_Bind.bind(Data_Either.bindEither)(Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Class.decodeJson(Data_Argonaut_Decode_Class.decodeForeignObject(Data_Argonaut_Decode_Class.decodeJsonJson))(res.value0.body))(function (v2) {
                          return Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeForeignObject(Data_Argonaut_Decode_Class.decodeJsonJson))(v2)("data");
                      }))(function (v2) {
                          return Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeJsonString)(v2)("image_url");
                      });
                      if (v1 instanceof Data_Either.Left) {
                          return Failure.value;
                      };
                      ...
                      throw new Error("Failed pattern match at Example.Cats (line 31, column 25 - line 33, column 52): " + [ v1.constructor.name ]);
                  };
                  throw new Error("Failed pattern match at Example.Cats (line 28, column 18 - line 33, column 52): " + [ res.constructor.name ]);
              })();
              return Pha_Update.modify(Data_Function["const"](status));
          });
      });
  };
  ...
  var main = Pha_App.app({
      init: {
          state: state,
          action: new Data_Maybe.Just(RequestCat.value)
      },
      view: view,
      update: update,
